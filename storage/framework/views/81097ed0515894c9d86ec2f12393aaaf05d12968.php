<?php $__env->startSection('titulo', "Listado de usuarios"); ?>
...
<ol class="toolbar">
    ...
    <li class="btn-item"><a title="Recargar" href="#" class="fa fa-refresh" aria-hidden="true" onclick='window.location.replace("/usuarios");'><span>Recargar</span></a></li>
</ol>
<?php $__env->stopSection(); ?>
...
<script>
	var dataTable = $('#grilla').DataTable({
        ...
        "pageLength": 25,
        "order": [[ 0, "asc" ]],
	    "ajax": "<?php echo e(route('usuarios.cargarGrilla')); ?>"
	});
</script>
<?php $__env->stopSection(); ?>
