...
<head>
  ...
  <link href="<?php echo e(asset('css/autogestion.css')); ?>" rel="stylesheet" type="text/css">
  ...
  <div id="wrapper">
   ...
   <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center  bg-white" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/home">
        <div class="sidebar-brand-text mx-3"><img src="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/images/logo.jpg" class="responsive"></div>
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/home">
...
<!-- Heading -->
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/inscripcion/">
          <i class="fas fa-fw fa-folder"></i>
          <span>NUEVA INSCRIPCIÓN</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/datospersonales">
          <i class="fas fa-fw fa-folder"></i>
          <span>Datos personales</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/carrerasactivas">
          <i class="fas fa-fw fa-folder"></i>
          <span>Carreras activas</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/historiaacademica">
          <i class="fas fa-fw fa-folder"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/constancia-inscripcion">Constancia inscripción</a>
...
-->
            ...
            <li class="nav-item no-arrow mx-1">
         		<a class="nav-link text-gray-600 small" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/contactos">Contacto</a>
            </li>
            <!-- Nav Item - User Information -->
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo e(Session::get("usuarioalu_nombre")); ?></span>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span class="d-block text-muted">©<?php echo e(date("Y")); ?> <?php echo e(env('APP_NAME')); ?> - <?php echo e(env('ORG_NAME')); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="<?php echo e(env('APP_URL_AUTOGESTION')); ?>/logout">Cerrar sesi&oacute;n</a>
          </div>
        </div>
      </div>
    </div>
