...
<?php $__env->startSection('titulo', "Datos del alumno"); ?>
...
<form id="form1" method="POST">
    <div class="row">
        ...
        <div class="form-group col-lg-4">
            <input onchange="fValidarNroDocumento();" type="text" id="txtNroDocumento" name="txtNroDocumento" class="form-control" required value="<?php echo e(isset($legajo->documento) ? $legajo->documento : ''); ?>">
        </div>
        <div class="form-group col-lg-2">
            <label>Nombre: *</label>
        </div>
        <div class="form-group col-lg-4">
            <input type="text" class="form-control" id="txtNombre" name="txtNombre" value="<?php echo e(isset($legajo->nombre) ? $legajo->nombre : ''); ?>" required>
        </div>
        <div class="form-group col-lg-2">
            <label>Apellido: *</label>
        </div>
        <div class="form-group col-lg-4">
            <input type="text" class="form-control" id="txtApellido" name="txtApellido" value="<?php echo e(isset($legajo->apellido) ? $legajo->apellido : ''); ?>" required>
        </div>
        <div class="form-group col-lg-2">
            <label>Email:</label>
        </div>
        ...
        <div class="form-group col-lg-4">
            <input type="text" id="txtTelParticular" name="txtTelParticular" class="form-control" required value="<?php echo e(isset($legajo->telparticular) ? $legajo->telparticular : ''); ?>">
        </div>
        <div class="form-group col-lg-2">
            <label>Teléfono laboral:</label>
        </div>
        <div class="form-group col-lg-4">
            <input type="text" id="txtTelLaboral" name="txtTelLaboral" class="form-control" required value="<?php echo e(isset($legajo->tellaboral) ? $legajo->tellaboral : ''); ?>">
        </div>
        <div class="form-group col-lg-2">
            <label>Nro de Legajo:</label>
        </div>
        <div class="form-group col-lg-4">
            <input type="text" id="txtNroLegajo" name="txtNroLegajo" class="form-control" value="<?php echo e(isset($legajo->nro_legajo) ? $legajo->nro_legajo : ''); ?>">
        </div>
        <div class="form-group col-lg-2">
            <label>Sexo:</label>
        </div>
