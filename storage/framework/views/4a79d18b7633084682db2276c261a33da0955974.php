<?php $__env->startSection('titulo', "Datos del permiso"); ?>
...
<form id="form1" method="POST">
    ...
    <div class="row">
        <div class="form-group col-lg-12">
            <label>Nombre: *</label>
            <input type="text" id="txtNombre" name="txtNombre" class="form-control" value="<?php echo e(isset($permiso->nombre) ? $permiso->nombre : ''); ?>" required>
        </div>
        <div class="form-group col-lg-12">
...
<script>
    ...
    function cargarGrilla() {
          var grilla = $('#grilla').DataTable({
            ...
            "bSearchable": false,
            "paging": false,
            "ajax": "<?php echo e(asset('permiso/cargarGrillaPatentesPorFamilia?fam='.$globalId)); ?>",
            "columnDefs": [
                {
                    "targets": [0],
                    "visible": false,
    ...
    function cargarGrillaPatentes() {
         var grilla = $('#grillaPatentes').DataTable({
            ...
            "bSearchable": true,
            "pageLength": 10,
            "ajax": "<?php echo e(asset('permiso/cargarGrillaPatentesDisponibles?fam='.$globalId)); ?>",
            "columnDefs": [
                {
                    "targets": [0],
                    "visible": false,
