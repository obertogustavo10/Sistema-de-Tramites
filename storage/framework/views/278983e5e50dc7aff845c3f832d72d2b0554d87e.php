                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select id="lstDia" class="form-control">
                                    <option value="" disabled selected>Seleccionar</option>
                                    <?php for($i = 0; $i < count($array_dia); $i++): ?>
                                        <option value="<?php echo e($array_dia[$i]->iddia); ?>"><?php echo e($array_dia[$i]->descdia); ?></option>
                                    <?php endfor; ?>
                                </select>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <select type="text" id="lstHrIni" class="form-control fecha-hora-min">
                                    <?php for($i = 0; $i < 24; $i++): ?>
                                    	<?php if($i < 10): ?>
                                        	<option value="<?php echo e($i); ?>">0<?php echo e($i); ?></option>
                                        <?php else: ?>
...
<script>
    ...
    function cargarGrilla() {
        ...
        grilla.destroy();
       	var grilla = $('#grilla').DataTable({
            ...
            "bSearchable": false,
            "paging": false,
            "ajax": "<?php echo e(asset('/previoinscripcion/ofertadecursada/cargarGrillaOfertaPorPlan?idplan=')); ?>" + idPlan,
            "columnDefs": [
             	{
                    "targets": [0],
                    "width": 600
    ...
    function fObtenerDatosDelPlan(){
        ...
        if(idPlan > 0){
            $.ajax({
                type: "GET",
                url: "<?php echo e(asset('actividad/plan/obtenerPlan')); ?>",
                data: { 
                        idPlan: idPlan,
                     },
                async: true,
