                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4">
                        <select id="lstAlumno" name="lstAlumno" class="form-control selectpicker" data-live-search="true">
                            ...
                            <?php for($i = 0; $i < count($array_alumno); $i++): ?>
                                <option value="<?php echo e($array_alumno[$i]->idalumno); ?>"><?php echo e($array_alumno[$i]->nombre); ?> <?php echo e($array_alumno[$i]->apellido); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    <div class="form-group col-lg-2">
...
<script>
	var dataTable = $('#grilla').DataTable({
        ...
        "pageLength": 25,
        "order": [[ 0, "asc" ]],
	    "ajax": "<?php echo e(route('certificado.cargarGrilla')); ?>"
	});
    ...
    function agregarCertificadoGrilla(){
         ...
         $.ajax({
            type: "GET",
            url: "<?php echo e(asset('certificado/guardar')); ?>",
            data: { 
                idAlumno:idAlumno, 
                fecha:fecha, 
