        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <label>Nombre: *</label>
                    <input type="text" id="txtNombre" name="txtNombre" class="form-control" value="<?php echo e(isset($actividad->descactividad) ? $actividad->descactividad : ''); ?>" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Nombre corto: *</label>
                    <input type="text" id="txtIdentificador" name="txtIdentificador" class="form-control" value="<?php echo e(isset($actividad->ncactividad) ? $actividad->ncactividad : ''); ?>" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Coordinador</label>
                    <select id="lstCoordinador" name="lstCoordinador" class="form-control selectpicker" data-live-search="true">
                        <option value="">-</option>
                        <?php for($i = 0; $i < count($array_personal); $i++): ?>
                            <?php if(isset($actividad) and $array_personal[$i]->idpersonal == $actividad->coordinador): ?>
                                <option selected value="<?php echo e($array_personal[$i]->idpersonal); ?>"><?php echo e($array_personal[$i]->nombre); ?> <?php echo e($array_personal[$i]->apellido); ?></option>
                            <?php else: ?>
                                <option value="<?php echo e($array_personal[$i]->idpersonal); ?>"><?php echo e($array_personal[$i]->nombre); ?> <?php echo e($array_personal[$i]->apellido); ?></option>
                            <?php endif; ?>
                        <?php endfor; ?>
                    </select>
                </div>
                 <div class="form-group col-lg-2">
                    ...
                    <select id="lstTitulo" name="lstTitulo" class="form-control" onchange="fotorgaTitulo();">
                        <option value="1" <?php echo e(isset($actividad) && $actividad->titulo_que_otorga != ""? 'selected' : ''); ?>>Si</option>
                        <option value="0" <?php echo e(isset($actividad) && $actividad->titulo_que_otorga == ""? 'selected' : ''); ?>>No</option>
                    </select>
                </div>
                 <div id="divTitulo" class="form-group col-lg-4" style="display: none;">
                    <label>Título</label>
                    <input type="text" id="txtTitulo" name="txtTitulo" class="form-control" value="<?php echo e(isset($actividad->titulo_que_otorga) ? $actividad->titulo_que_otorga : ''); ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <select id="lstSede" name="lstSede" class="form-control selectpicker" data-live-search="true" onchange="abrirAltaSede();">
                                    ...
                                    <?php for($i = 0; $i < count($array_sede); $i++): ?>
                                        <option value="<?php echo e($array_sede[$i]->idsede); ?>"><?php echo e($array_sede[$i]->descsede); ?></option>
                                    <?php endfor; ?>
                                </select>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select id="lstDirector" name="lstDirector" class="form-control selectpicker" data-live-search="true">
                                    <?php for($i = 0; $i < count($array_personal); $i++): ?>
                                        <option value="<?php echo e($array_personal[$i]->idpersonal); ?>"><?php echo e($array_personal[$i]->nombre . " " . $array_personal[$i]->apellido); ?></option>
                                    <?php endfor; ?>
                                </select>
...
<script>
    ...
    function guardar() {
     ...
     function cargarGrilla() {
            ...
            "bSearchable": false,
            "paging": false,
            "ajax": "<?php echo e(asset('/actividad/actividad/cargarGrillaSedeActividad?idactividad='.$globalId)); ?>",
            "columnDefs": [
             	{
                    "targets": [0],
                    "width": 600
    ...
    function agregarSedeEnSelect(){
        ...
        if(descripcion != "" && nombre != ""){
            $.ajax({
                type: "GET",
                url: "<?php echo e(asset('publico/sede/agregarSedeAjax')); ?>",
                data: { 
    ...
    function frecargarSedeEnSelect(idSede){
        $.ajax({
            type: "GET",
            url: "<?php echo e(asset('publico/sede/obtenerTodos')); ?>",
            async: true,
            dataType: "json",
            success: function (data) {
                $("#lstSede").empty();
    ...
    <?php else: ?>
        <?php if($actividad->titulo_que_otorga != ""): ?>
            $("#divTitulo").show();
        <?php endif; ?>
    <?php endif; ?>
</script>
