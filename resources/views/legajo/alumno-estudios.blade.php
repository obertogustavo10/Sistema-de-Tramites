...
<div class="row">
    <div class="col-lg-12">
        <ul class="nav nav-pills">
          ...
          <li class="nav-item">
            <a class="nav-link" href="legajo/alumno/datos-personales/4">Estudios cursados</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="legajo/alumno/estudios/4">Cursos realizados</a>
          </li>
        ...
        <div class="col-lg-12">
            <div class="card mb-3">
                <div class="card-header">
                    <i class="fa fa-home"></i> Estudios cursados
