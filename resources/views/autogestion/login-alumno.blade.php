            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{env('APP_URL_AUTOGESTION')}}/nuevo-registro">Nuevo registro</a>
                  </div>
                  <div class="text-center">
              ...
              <div class="col-lg-6 d-none d-lg-block pt-4">
                ...
                <div class="alert alert-success mb-4" role="alert">
                  ...
                  <hr>
                  <p class="mb-0">Si tenes inconvenientes para acceder al sistema podes contactarnos haciendo <a href="{{env('APP_URL_AUTOGESTION')}}/contacto">click aquí</a></p>
                </div>
