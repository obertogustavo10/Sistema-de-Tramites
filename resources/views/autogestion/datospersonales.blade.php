...
<form id="form1" method="POST">
    <div class="row">
        ...
        <div class="form-group col-lg-4">
            <input type="text" id="txtTelParticular" name="txtTelParticular" class="form-control" value="{{$legajo->telparticular or ''}}">
        </div>
        <div class="form-group col-lg-2">
            <label>Teléfono laboral:</label>
        </div>
        <div class="form-group col-lg-4">
            <input type="text" id="txtTelLaboral" name="txtTelLaboral" class="form-control" value="{{$legajo->tellaboral or ''}}">
        </div>
        <div class="form-group col-lg-2">
            <label>Nro de Legajo:</label>
        </div>
        <div class="form-group col-lg-4">
            <input type="text" id="txtNroLegajo" name="txtNroLegajo" class="form-control" disabled value="{{$legajo->nro_legajo or ''}}">
        </div>
        <div class="form-group col-lg-2">
            <label>Sexo:</label>
        </div>
        ...
        <div class="form-group col-lg-4">
            <input type="text" id="txtCuit" name="txtCuit" class="form-control" value="{{$legajo->cuit or ''}}">
        </div>
        <div class="form-group col-lg-2">
