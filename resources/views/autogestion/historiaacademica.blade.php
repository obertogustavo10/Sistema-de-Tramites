              ...
              <tbody>
                @foreach($array_materias_aprobadas as $materia)
                  @if($materia->nota_alumno)
                    <tr role="row">
                      <td>{{$materia->descmateria}}</td>
                      <td>{{isset($materia->notaenletras)?$materia->notaenletras:""}}</td>
                      ...
                      <td>{{isset($materia->resolucionexime) && $materia->resolucionexime != ""? "Res. " . $materia->resolucionexime:""}}</br>
                      {{isset($materia->expedienteexime) && $materia->expedienteexime != ""? "Exp. " . $materia->expedienteexime:""}}</br>
                      {{isset($materia->fecharesolexime) && $materia->fecharesolexime != ""?date_format(date_create($materia->fecharesolexime), 'd/m/Y'):""}}</td>
                      <td>{{isset($materia->cargahorariaenhs)?$materia->cargahorariaenhs:""}} hs.</td>
                    </tr>
                @endif
                @endforeach
