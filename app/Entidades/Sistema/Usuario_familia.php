...
{
    protected $table = 'sistema.usuario_familia';
    ...
    public function insertar() {
        $sql = "INSERT INTO sistema.usuario_familia (
                    fk_idfamilia,
                    fk_idusuario,
                    fk_idarea
                    ) VALUES (?, ?, ?);";
