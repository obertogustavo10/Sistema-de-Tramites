...
class Domicilio extends Model
{
    ...
    protected $fillable = [
        'iddomicilio', 'direccion', 'localidad', 'fk_idtidomicilio', 'fk_idprov', 'codpost', 'fk_idpersonal', 'fk_idpais', 'predeterminado'
    ];
